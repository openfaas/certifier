...
clean-swarm:
	-  docker service rm stronghash env-test env-test-labels env-test-annotations env-test-verbs test-secret test-scaling ; docker secret rm secret-api-test-key
